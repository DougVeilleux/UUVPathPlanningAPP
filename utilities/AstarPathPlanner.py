...
class AStarPathPlanner:
    ...
    def get_neighbors(self, node, search_radius=0.02):
        """
        ...
        # Print the number of neighbors found and the distances
        print("Number of neighbors found:", len(closest_neighbor_nodes))
